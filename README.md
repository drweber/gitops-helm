...
[![Build Status](https://travis-ci.org/drweber/gitops-helm.svg?branch=master)](https://travis-ci.org/drweber/gitops-helm)
...
![gitops](https://github.com/drweber/openfaas-flux/blob/master/docs/screens/flux-helm-gitops.png)
...
You can fork the [gitops-helm](https://github.com/drweber/gitops-helm) project and use it as a template for your cluster config.
...
--set git.url=git@github.com:drweber/gitops-helm \
--namespace flux \
weaveworks/flux
```
...
I will be using [podinfo](https://github.com/drweber/k8s-podinfo) to demonstrate a full CI/CD pipeline including promoting releases between environments.  
...
```
$ cd hack && ./ci-mock.sh -r drweber/podinfo -b dev
...
....
Step 12/15 : COPY --from=builder /go/src/github.com/drweber/k8s-podinfo/podinfo .
....
Step 15/15 : CMD ["./podinfo"]
....
Successfully built 71bee4549fb2
Successfully tagged drweber/podinfo:dev-kb9lm91e
The push refers to repository [docker.io/drweber/podinfo]
36ced78d2ca2: Pushed 
```
...
spec:
  ...
  chart:
    ...
    ref: master
  values:
    image: drweber/podinfo:dev-kb9lm91e
    replicaCount: 1
```
...
![gitops-automation](https://github.com/drweber/openfaas-flux/blob/master/docs/screens/flux-helm-image-update.png)
...
![gitops-chart-change](https://github.com/drweber/openfaas-flux/blob/master/docs/screens/flux-helm-chart-update.png)
...
```bash
$ cd hack && ./ci-mock.sh -r drweber/podinfo -b stg

Successfully tagged drweber/podinfo:stg-9ij63o4c
The push refers to repository [docker.io/drweber/podinfo]
8f21c3669055: Pushed 
```
...
spec:
  ...
  chart:
    ...
    ref: master
  values:
    image: drweber/podinfo:stg-9ij63o4c
    replicaCount: 2
    hpa:
      enabled: true
      maxReplicas: 10
...
* make the CI tooling publish images from my hotfix branch to `drweber/podinfo:hotfix-sha`
...
```bash
$ cd hack && ./ci-mock.sh -r drweber/podinfo -v 0.4.10

Successfully built f176482168f8
Successfully tagged drweber/podinfo:0.4.10
``` 
...
```bash
$ cd hack && ./ci-mock.sh -r drweber/podinfo -v 0.4.11

Successfully tagged drweber/podinfo:0.4.11
```

![gitops-semver](https://github.com/drweber/openfaas-flux/blob/master/docs/screens/flux-helm-semver.png)
...
![SealedSecrets](https://github.com/drweber/openfaas-flux/blob/master/docs/screens/flux-secrets.png)
